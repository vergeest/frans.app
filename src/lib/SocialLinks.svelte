<div class="flex gap-8 text-white/75">
	<a
		href="https://www.instagram.com/frans.vergeest/"
		rel="noreferrer noopener"
		class="block transition-colors md:hover:text-green"
	...
	<a
		href="https://www.linkedin.com/in/vergeest"
		rel="noreferrer noopener"
		target="_blank"
